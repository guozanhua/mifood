...
<link href="/MIFOOD/Public/css/classify.css" rel="stylesheet" type="text/css" media="all" />
<!-- font-awesome icons -->
<link href="/MIFOOD/Public/css/font-awesome.css" rel="stylesheet" type="text/css" media="all" /> 
<link href="/MIFOOD/Public/css/test.css" rel="stylesheet" type="text/css" media="all" />
...
<!-- header -->
	<div class="agileits_header">
		...
		<div class="w3l-right">
		<ul>
		<?php if($_SESSION['user'] == '' ): ?><li><span><img src="/MIFOOD/Public/images/location.png" />&nbsp&nbsp长沙</span></li>
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="/MIFOOD/index.php/Home/Index/classify/24"><span style="color:#E64C3C">分类</span></a><i>/</i></li>
...
<!-- banner -->
	<div class="banner">
			 ...
			 <!-- Brand and toggle get grouped for better mobile display -->
			  <div class="navbar-header nav_2">
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				...
				<?php if(is_array($category)): foreach($category as $key=>$v): ?><li><a href="/MIFOOD/index.php/Home/Index/classify/category_id/<?php echo ($v['category_id']); ?>"><?php echo ($v["category_name"]); ?></a></li><?php endforeach; endif; ?>
		...
		<div class="w3l_banner_nav_right">
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="/MIFOOD/Public/css/flexslider.css" type="text/css" media="screen" property="" />
				<script defer src="/MIFOOD/Public/js/jquery.flexslider.js"></script>
				<script type="text/javascript">
	...
	<div id="top-brands">
		<div class="container">
			<h3><?php echo ($oneCategory[0]['category_name']); ?></h3>
			<div class="agile_top_brands_grids">
			<div id='ajaxpage'>
<div class='page' style='display:none;'><a href="<?php echo U('classsify',array('p'=>1));?>" title="">自动点击执行AJAX请求显示第一页内容</a></div> 
</div>
 <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><div class="col-md-3 top_brand_left">
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="/MIFOOD/index.php/Home/Index/details/shop_id/<?php echo ($list['shop_id']); ?>"><img title=" " alt=" " src="<?php echo ($list['shop_img']); ?>" width="180" height="140"/></a>		
											<p><?php echo ($list['shop_name']); ?></p>
											<h4>【<?php echo ($list['area']); echo ($list['zone']); ?>】</h4>
										</div>
										<div class="snipcart-details top_brand_home_details">
												<fieldset>

													<a href="/MIFOOD/index.php/Home/Index/details/shop_id/<?php echo ($list['shop_id']); ?>"><input type="submit" name="submit" value="去看看" class="button" /></a>
												</fieldset>
	  ...
	  <?php if(($k == 4)or($k == 8) ): ?><div class="clearfix"> </div>
			</div>
		</div>
				<div class="container">
			<div class="agile_top_brands_grids"><?php endif; endforeach; endif; else: echo "" ;endif; ?> 
				<div class="clearfix"> </div>
