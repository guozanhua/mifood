				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="/MIFOOD/index.php/Home/Index/index" class="menu__link">首页</a></li>
							<li class="menu__item"><a href="/MIFOOD/index.php/Home/Index/top" class="menu__link">Top系列</a></li> 
							<li class="menu__item"><a href="/MIFOOD/index.php/Home/Index/classify/category_id/7" class="menu__link">分类</a></li> 
							<li class="menu__item"><a href="/MIFOOD/index.php/Home/Index/health" class="menu__link">写食派</a></li> 
...
<!-- //login -->
      <div class="page_container">
    	<div class="breadcrumb">
        	<div class="wrap">
                <div class="container">
                    <a href="index.html">全部</a><span>/</span>美食记录
                </div>
            </div> 
        </div>
    	<!--MAIN CONTENT AREA-->
        <div class="wrap">
            <div class="container inner_content">
                <div id='ajaxpage'>
<div class='page1' style='display:none;'><a href="<?php echo U('search',array('p'=>1));?>" title="">自动点击执行AJAX请求显示第一页内容</a></div> 
</div>
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="home">
    <div class="agile_top_brands_grids">
      <div class="container">
 <?php if(is_array($shop)): $k = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($k % 2 );++$k;?><div class="col-md-3 top_brand_left">
                    <div class="hover14 column">
                        <div class="agile_top_brand_left_grid">
                             <div class="tag"><img src="/MIFOOD/Public/images/tag.png" alt=" " class="img-responsive" /></div>
               ...
               <?php if(($k == 4)or($k == 8)or($k == 12) ): ?></div>
                        <div class="agile_top_brands_grids" >
                        <div class="container"><?php endif; endforeach; endif; else: echo "" ;endif; ?> 
                <div class="clearfix"> </div>
